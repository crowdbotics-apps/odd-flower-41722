"""
Django settings for odd_flower_41722 project.
...
ROOT_URLCONF = 'odd_flower_41722.urls'
...
WSGI_APPLICATION = 'odd_flower_41722.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "odd_flower_41722 API",
    "DESCRIPTION": "API documentation for odd_flower_41722 App",
    "VERSION": "v1",
}
